    ...
    <div className="portfolio">
      ...
      <div className="content">
        <section className="section">
          <h2>Introduction</h2>
          <p>
            I'm rahul naik, a B.Tech student with a passion for Artificial Intelligence and Machine Learning,from VIT-AP
          </p>
        </section>
        ...
        <section className="section">
          <h2>Contact</h2>
          <a href="mailto:rahulnayaksanu32@gmail.com">Email me</a>
        </section>
      </div>
    </div>
  );
